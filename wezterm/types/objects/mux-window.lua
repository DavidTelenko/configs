...
---@field spawn_tab fun(self: MuxWindow, opts: { cwd?: string, args?: string, set_environment_variables?: table<string, string>, domain?: string | { DomainName: string } }): MuxTabObj, Pane, MuxWindow Spawns a program into a new tab within this window, returning the MuxTab, Pane and MuxWindow objects associated with it. When no arguments are passed, the default program is spawned.
