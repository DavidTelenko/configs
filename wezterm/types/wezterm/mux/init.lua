...
---@field spawn_window fun(...: any): MuxTabObj, Pane, MuxWindow Spawns a program into a new window, returning the MuxTab, Pane and MuxWindow objects associated with it. When no arguments are passed, the default program is spawned. TODO
